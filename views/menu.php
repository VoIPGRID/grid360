...
<head>
    ...
    <link href="<?php echo ASSETS_URI; ?>bootstrap/css/bootstrap.css" rel="stylesheet" />
    <link href="<?php echo ASSETS_URI; ?>bootstrap/css/bootstrap-responsive.css" rel="stylesheet" />
    <link href="<?php echo ASSETS_URI; ?>css/css.css" rel="stylesheet" />
    <script type="text/javascript" src="//code.jquery.com/jquery-latest.js"></script>
    <script type="text/javascript" src="<?php echo ASSETS_URI; ?>bootstrap/js/bootstrap.js"></script>
    <link rel="icon" type="image/png" href="<?php echo ASSETS_URI; ?>images/favicon.gif" />
</head>
<body>
<div class="container">
    <div class="navbar">
        <div class="navbar-inner">
            <a class="brand" href="//www.voipgrid.nl"><img class="logo" src="<?php echo ASSETS_URI; ?>images/logo.png" /></a>
