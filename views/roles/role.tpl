<form action="{$MANAGER_URI}role/submit" method="POST" class="form-horizontal">
    <fieldset>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input id="roleName" name="name" type="text" placeholder="Role name" class="input-large" {if isset($role)}value="{$role.name}"{/if} />
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <textarea id="roleDescription" name="description" placeholder="Role description" class="input-xxlarge">{if isset($role)}value="{$role.description}"{/if}</textarea>
            </div>
        </div>
