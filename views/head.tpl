...
<link href="{$ASSETS_URI}bootstrap/css/bootstrap.css" rel="stylesheet" />
<link href="{$ASSETS_URI}bootstrap/css/bootstrap-responsive.css" rel="stylesheet" />
<link href="{$ASSETS_URI}fontawesome/css/font-awesome.min.css" rel="stylesheet" />
